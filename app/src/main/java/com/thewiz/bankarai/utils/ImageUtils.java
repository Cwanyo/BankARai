...
public class ImageUtils {
    ...
    static {
        try {
            ...
            Log.e(TAG, "tensorflow_bankarai.so not found, native RGB -> YUV conversion may be unavailable.");
        }
    }
    ...
    public static void convertYUV420ToARGB8888(
        ...
        if (useNativeConversion) {
            try {
                ...
                Log.w(TAG,"Native YUV420 -> RGB implementation not found, falling back to Java implementation");
